...
# df_data['credit_category'] =le.fit_transform(df_data['credit_category'].astype(str))
# df_data['credit_type'] =le.fit_transform(df_data['credit_type'].astype(str))
# df_data['customer_priority_type'] =le.fit_transform(df_data['customer_priority_type'].astype(str))
# df_data['device_brand'] =le.fit_transform(df_data['device_brand'].astype(str))
# df_data['device_type'] =le.fit_transform(df_data['device_type'].astype(str))
# df_data['account_type'] =le.fit_transform(df_data['account_type'].astype(str))
# df_data['lte_flag'] =le.fit_transform(df_data['lte_flag'].astype(str))
# df_data['ced_selfcare_app_user'] =le.fit_transform(df_data['ced_selfcare_app_user'].astype(str))
# df_data['ced_online_shopper'] =le.fit_transform(df_data['ced_online_shopper'].astype(str))
# df_data['ced_overseas_travellers'] =le.fit_transform(df_data['ced_overseas_travellers'].astype(str))
# df_data['ced_cricket_lover'] =le.fit_transform(df_data['ced_cricket_lover'].astype(str))
# df_data['ced_social_media'] =le.fit_transform(df_data['ced_social_media'].astype(str))
# df_data['ced_movie_lover'] =le.fit_transform(df_data['ced_movie_lover'].astype(str))
# df_data['ced_music_lover'] =le.fit_transform(df_data['ced_music_lover'].astype(str))
# df_data['cem_news'] =le.fit_transform(df_data['cem_news'].astype(str))
# df_data['cem_netflix'] =le.fit_transform(df_data['cem_netflix'].astype(str))
# df_data['ez_customer'] =le.fit_transform(df_data['ez_customer'].astype(str))
df_data=pd.concat([
df_data.get(["short_answer","call_count_6","duration_queue_sum_6","duration_tot_sum_6","visit_count","totaldurwait_sum_6","totaldurserve_sum_6","break_count","complete_duration_sum_6","arpu","network_stay","age","star_point_bal","total_idd_rev","total_gprs_volume","voice_rev","sms_rev","nov_d","nov_nd","dec_d","dec_nd","jan_d","jan_nd","feb_d","feb_nd","mar_d","mar_nd","apr_d","apr_nd","nov_od_dur","nov_ond_dur","dec_od_dur","dec_ond_dur","jan_od_dur","jan_ond_dur","feb_od_dur","feb_ond_dur","mar_od_dur","mar_ond_dur","apr_od_dur","apr_ond_dur","nov_id_dur","nov_ind_dur","dec_id_dur","dec_ind_dur","jan_id_dur","jan_ind_dur","feb_id_dur","feb_ind_dur","mar_id_dur","mar_ind_dur","apr_id_dur","apr_ind_dur","nov_od_count","nov_ond_count","dec_od_count","dec_ond_count","jan_od_count","jan_ond_count","feb_od_count","feb_ond_count","mar_od_count","mar_ond_count","apr_od_count","apr_ond_count","nov_id_count","nov_ind_count","dec_id_count","dec_ind_count","jan_id_count","jan_ind_count","feb_id_count","feb_ind_count","mar_id_count","mar_ind_count","apr_id_count","apr_ind_count","lastatlstate","avgatlstate","lastadlstate","avgadlstate"])
...
label_col='short_answer'

# scale the feature MinMax, build array
y_train = (df_train.loc[:,label_col].values).reshape(-1,1)
df_train.drop(['short_answer'],axis=1,inplace=True)
...
df_test.drop(['short_answer'],axis=1,inplace=True)
